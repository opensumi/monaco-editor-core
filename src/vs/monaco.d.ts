...
declare namespace monaco.editor {
	...
	*/
	...
	export interface ITextModel {
		 ...
		 * @internal
		 */
		getTokenTypeIfInsertingCharacter(lineNumber: number, column: number, character: string): any;
		/**
		 * @internal
		*/
		tokenizeLineWithEdit(position: IPosition, length: number, newText: string): any | null;
		/**

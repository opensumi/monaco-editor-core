...
function createCompile(src: string, build: boolean, emitError: boolean, transpileOnly: boolean | { swc: boolean }, module?: ts.ModuleKind) {
...
export function compileTask(src: string, out: string, build: boolean, options: { disableMangle?: boolean } = {}, extractConstEnum: boolean, module?: ts.ModuleKind): task.StreamTask {
